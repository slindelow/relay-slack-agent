...
| 10 — Send response | ✅ PASS (needs redeploy regression) | sofialindelow | 2026-06-24 | Send posts the response into #test-customer as the RELAY bot and resolves the question. UX issue fixed 2026-06-25: customer-facing copy now avoids raw Slack IDs and internal approval wording. Re-test after deploy. |
