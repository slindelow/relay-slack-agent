...
def test_customer_response_text_has_no_relay_branding_or_raw_id():
    ...
    # The customer message is just the reply — no RELAY mention, no approval
    # framing, no raw Slack ID. Attribution comes from the CSM name/avatar.
